    ...
    card.querySelector('.card_edit').addEventListener("click", (e) => {
        //click to edit
           ...
           const cardId = card.id.split('-')[1]
            ...
            fetch('https://studentcorner.onrender.com/updatetodo', {
                method: 'POST',
        ...
        fetch('https://studentcorner.onrender.com/addtodo', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
...
// fetch('https://localhost:3000/addTodo', {
//     method: 'POST',
//     headers: { 'Content-Type': 'application/json' },
//     body: JSON.stringify({
//         title: title,
...
function displayTodos() {
    ...
    fetch('https://studentcorner.onrender.com/todoItems')
        .then(data => data.json())
        .then(resp => {
            ...
            for (let i = 0; i < resp.length; i++) {
                ...
                cards.forEach((card, cardCount) => {
                  ...
                  card.querySelector('.card_delete').addEventListener('click', () =>{
                    ...
                    fetch('https://studentcorner.onrender.com/deletetodo', {
                        method: 'DELETE',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({
                            id: id,
