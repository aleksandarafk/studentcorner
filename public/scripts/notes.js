...
cardTheme.forEach(elem => {
    elem.addEventListener('click', () => {
        ...
        fetch('https://studentcorner.onrender.com/addnote', {
            method: 'POST',
...
function displayNotes() {
    ...
    fetch('https://studentcorner.onrender.com/notesItems')
        .then(data => data.json())
        .then(resp => {
            ...
            for (let i = 0; i < resp.note.length; i++) {
                ...
                cards.forEach((card, cardCount) => {
                    ...
                    card.querySelector('.card_edit').addEventListener("click", () => {
                        ...
                        if (editable[cardCount]) {
                            ...
                            fetch('https://studentcorner.onrender.com/updatenote', {
                                method: 'POST',
                                headers: { 'Content-Type': 'application/json' },
                                body: JSON.stringify({
                                    id: id,
                ...
                card.querySelector('.card_delete').addEventListener('click', () =>{
                    ...
                    fetch('https://studentcorner.onrender.com/deletenotes', {
                        method: 'DELETE',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({
                            id: id,
